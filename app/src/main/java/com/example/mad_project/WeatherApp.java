...
public class WeatherApp {
    ...
    public long getId() { return id; }          // Renamed from getid()
    public void setId(long value) { this.id = value; } // Renamed from setid()
    ...
    // -----------------------------
    // Nested Classes as "public static"
    // so they're accessible outside WeatherApp
    // -----------------------------
